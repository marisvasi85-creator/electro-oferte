...
export const SYMBOL_LIBRARY: SymbolDefinition[] = [
  ...
  { type: "intrerupator_simplu", category: "intrerupatoare", label: "Întrerupător unipolar", legend: "Într. unipolar", width: 14, height: 14 },
  { type: "intrerupator_dublu", category: "intrerupatoare", label: "Întrerupător bipolar", legend: "Într. bipolar", width: 16, height: 14 },
  { type: "intrerupator_cap_scara", category: "intrerupatoare", label: "Comutator cap-scară", legend: "Cap-scară", width: 16, height: 14 },
  { type: "intrerupator_cruce", category: "intrerupatoare", label: "Comutator cruce", legend: "Cruce", width: 16, height: 16 },
